...
public interface ItemTouchHelperAdapter {
     ...
     * <br/>
     * Implementations should call {@link android.support.v7.widget.RecyclerView.Adapter#notifyItemMoved(int, int)}
     ...
     *
     * @see android.support.v7.widget.RecyclerView#getAdapterPositionFor(RecyclerView.ViewHolder)
